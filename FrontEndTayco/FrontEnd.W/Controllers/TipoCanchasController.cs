    ...
    public class TipoCanchasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tipoCancha = await _context.TipoCancha
                .FirstOrDefaultAsync(m => m.TipoCanchaId == id);
            if (tipoCancha == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("TipoCanchaId,NombreCancha,Descripcion")] TipoCancha tipoCancha)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoCanchaId,NombreCancha,Descripcion")] TipoCancha tipoCancha)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TipoCanchaExists(tipoCancha.TipoCanchaId))
                    {
                        return NotFound();
                    }
                    else
