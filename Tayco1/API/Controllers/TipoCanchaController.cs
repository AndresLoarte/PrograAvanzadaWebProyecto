...
namespace API.Controllers
{
    ...
    public class TipoCanchaController : ControllerBase
    {
        ...
        {
            var mappux = _mapper.Map<DataModels.TipoCancha, data.TipoCancha>(tipoCancha);
            new BS.TipoCancha(_context).Insert(mappux);
        ...
        {
            return (new BS.TipoCancha(_context).GetOneById(id) != null);
        }
    }
}
